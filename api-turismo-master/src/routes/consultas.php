...
$app->get("/voucher/{id:[0-9]+}", function (Request $request, Response $response, array $args) {
    $referencia = "0002";
    $referenciaA = "Hotel Internacional Potrero de Los funes";
    $referenciaA = mb_convert_encoding($referenciaA,  "Windows-1252", "UTF-8");
    $referenciaB = "AX75SA";
    ...
    //Primera página
    $pdf->AddPage();
    $pdf->Image('http://www.turismo.sanluis.gov.ar/api-turismo/public/voucher/voucher2_1.jpg', 10, 10, 150);
    $pdf->SetXY(30, 12);
    $pdf->SetFont('Arial', 'B', 30);
    $pdf->SetTextColor(255, 255, 255);
    $pdf->Cell(100, 10, $referencia);
    $pdf->SetXY(25, 130);
    $pdf->SetFont('Arial', 'B', 12);
    $pdf->SetTextColor(0, 0, 0);
    $pdf->MultiCell(80, 5, $referenciaA, 1, 'C', 0);
    $pdf->SetXY(117, 120);
    $pdf->SetFont('Arial', 'B', 25);
    $pdf->SetTextColor(255, 255, 255);
    $pdf->Cell(100, 10, $referenciaB);
    $txt = utf8_decode($txt);
    $pdf->Output();
