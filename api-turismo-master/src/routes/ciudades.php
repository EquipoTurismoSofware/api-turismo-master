...
$app->get("/ciudad/{id:[0-9]+}/gastronomia", function (Request $request, Response $response, array $args) {
    $xSQL = "SELECT * FROM gastronomia";
    $xSQL .= " WHERE gastronomia.idlocalidad = " . $args["id"];
...
//Todos lugares gastronomicos de una Ciudad (Localidad) + Imágenes
$app->get("/ciudad/{id:[0-9]+}/gastronomia/imagenes", function (Request $request, Response $response, array $args) {
...
$app->get("/ciudades", function (Request $request, Response $response, array $args) {
    $xSQL = "SELECT ciudades.id, ciudades.nombre, ciudades.activo, departamentos.nombre as departamento FROM ciudades";
    $xSQL .= " INNER JOIN departamentos ON ciudades.iddepartamento = departamentos.id";
    $xSQL .= " WHERE ciudades.activo = 1";
