...
//Trae atractivos de caminos pintorescos 
$app->get("/atractivos/campintur", function (Request $request, Response $response, array $args) {
    ...
    $xSQL .= " WHERE clasificacion.nombre Like '%Caminos Pintorescos%'";
    $xSQL .= " ORDER BY atractivos.nombre";
    $respuesta = dbGet($xSQL);
